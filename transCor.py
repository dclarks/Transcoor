...
class JanelaPrincipal(QDialog, interfaceGrafica.Ui_Form):
    def __init__(self, parent=None):
        ...
        self.pushButton.clicked.connect(self.converteCoordenadas_abre_arquivo_txt)
    ...
    # ABA CONVERTE COORDENADAS
    def converteCoordenadas_abre_arquivo_txt(self):
        aux = QFileDialog.getOpenFileName(None, 'Open File', 'Abrir Arquivo txt',
                                          'Arquivo *.txt ')
    ...
    def exporta_dxf(self):
        ...
        print((vax, vay, vaz, indice, descricao, descricao_layer, nome_completo_do_arquivo_dxf,N_estacao,E_estacao,Z_estacao,indice_estacao,descricao_estacao))
